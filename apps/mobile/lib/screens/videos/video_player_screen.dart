...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  Future<void> _saveProgress(double pos) async {
    try {
      await _api.post('/videos/${widget.videoId}/progress', data: {
        'position': pos.toInt(),
...
<div id="wrap">
  <div id="blk-top"></div>
  <iframe id="player"
    src="https://www.youtube-nocookie.com/embed/$videoId?autoplay=0&mute=0&controls=0&modestbranding=1&rel=0&iv_load_policy=3&disablekb=1&fs=0&enablejsapi=1&playsinline=1&showinfo=0&color=white$startParam&origin=https://alledu.app"
